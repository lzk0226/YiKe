<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="评分用户ID" prop="userId">
        <el-input
          v-model="queryParams.userId"
          placeholder="请输入评分用户ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="评分时间" prop="createdAt">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['yike:ratings:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['yike:ratings:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="ratingsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评分时间" align="center" prop="createdAt" width="180">
...
<script>
import { listRatings, getRatings, delRatings, addRatings, updateRatings } from "@/api/yike/ratings"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除笔记评分编号为"' + ids + '"的数据项？').then(function() {
        return delRatings(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('yike/ratings/export', {
        ...this.queryParams
