...
public class UserFavoritesController extends BaseController
{
     ...
     * 查询用户收藏列表
     */
    @PreAuthorize("@ss.hasPermi('yike:favorites:list')")
    @GetMapping("/list")
     ...
     * 导出用户收藏列表
     */
    @PreAuthorize("@ss.hasPermi('yike:favorites:export')")
     ...
     * 获取用户收藏详细信息
     */
    @PreAuthorize("@ss.hasPermi('yike:favorites:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户收藏
     */
    @PreAuthorize("@ss.hasPermi('yike:favorites:add')")
     ...
     * 修改用户收藏
     */
    @PreAuthorize("@ss.hasPermi('yike:favorites:edit')")
     ...
     * 删除用户收藏
     */
    @PreAuthorize("@ss.hasPermi('yike:favorites:remove')")
