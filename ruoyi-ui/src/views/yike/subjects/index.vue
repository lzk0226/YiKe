  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['yike:subjects:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['yike:subjects:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学科描述" prop="description">
          <el-input v-model="form.description" placeholder="请输入学科描述" />
        </el-form-item>
        <el-form-item label="排序权重" prop="sortOrder">
...
<script>
import { listSubjects, getSubjects, delSubjects, addSubjects, updateSubjects } from "@/api/yike/subjects"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学科分类编号为"' + ids + '"的数据项？').then(function() {
